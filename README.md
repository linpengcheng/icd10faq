...
- [**★ 基于数学证明与价值抽象的现代化科学ICD编码,实现`DRG费用结算`,`ICD编码`,`主诊选择`,`医疗服务`，`医学知识`大统一. ---- 儒家大统一之道--学科融合**(国际疾病分类、AI、数学、会计) (更新到2019.09.22版)),](https://github.com/linpengcheng/PurefunctionPipelineDataflow/blob/master/doc/Tao_ICD.md)
...
- [“DRGs费用结算，ICD编码、为患者提供的医疗服务、医学参考文献”一致原则(以脑出血分期与编码为例), 即: 基于数学证明与价值抽象(货币,一般等价物),实现`DRG费用结算`,`ICD编码`,`主诊选择`,`医疗服务`，`医学知识`大统一](./doc/I6X.md)
...
- [R74.8`葡萄糖-6-磷酸脱氢酶缺乏`(附注意与`葡萄糖-6-磷酸酶缺乏`区别)](./doc/R74_8.md)
...
- [86.3鼻部血管瘤和唇部血管瘤这类的血管瘤切除术是编86.3x15皮肤及皮下血管瘤切除术还是编各部位病损切除术？](./doc/86_3.md)
- [88.4`脑动脉造影术`需要另编`股动脉插管术`吗？](./doc/88.md)
- [什么情况下植入物应另编说明性编码？](./doc/Implant_and_additional_code.md)
